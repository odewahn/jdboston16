...
_Cambridge, MA_.  The [Jupyter Project](http://jupyter.org/), [Harvard-Smithsonian Center for Astrophysics](https://www.cfa.harvard.edu/), and  [O'Reilly Media](http://www.oreilly.com/) are pleased to announce the program for the third [Jupyter Day](http://blog.jupyter.org/2016/02/16/jupyterdays-boston-2016/) series, which will be held at Harvard Law School on March 17-18.  Please see the [conference page](https://www.eventbrite.com/e/jupyterdays-boston-2016-tickets-21440120979) for details and registration information.
...
* Elaine Angelino from the [Berkeley Institute Data Science ](http://bids.berkeley.edu/) lays out an ambitious new Jupyter-based Data Science curriculum being rolled out across the University

The second day is your chance to get your hands dirty and learn from the experts how to use and run the platform:

* Laurent Gautier from [Novartis](https://www.novartis.com/) explores how to make the most of the many, many languages and tools Jupyter supports.  It's not just for Python anymore!
...
Finally, we'll also have tutorials on the technologies you need to understand to make the most of the Jupyter environment:
...
We look forward to a great two days of talk and conversation, and look forward to seeing you there.
